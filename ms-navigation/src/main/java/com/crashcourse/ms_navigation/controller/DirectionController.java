...
import com.crashcourse.ms_navigation.service.GeoService;
...
public class DirectionController {
    ...
    public Long getDuration(@RequestParam("from_latitude") Double fromLatitude,
                            @RequestParam("from_longitude") Double fromLongitude,
                            @RequestParam("to_longitude") Double toLongitude,
                            @RequestParam("to_latitude") Double toLatitude) {
        return geoService.getDuration(fromLongitude, fromLatitude, toLongitude, toLatitude);
    }
