...
| APPNAVIGATION_KAFKA_MAX_BLOCK               | нет        |   6000                                                  | Время (мс) в течение которого сервис пытается отправить сообщение в apache kafka |
...
| APPUSERS_KAFKA_MAX_BLOCK          |нет         |    6000                                                    | Время (мс) в течение которого сервис пытается отправить сообщение в apache kafka |
...
| APPDEPARTURE_KAFKA_MAX_BLOCK                | нет        |    6000                                                    | Время (мс) в течение которого сервис пытается отправить сообщение в apache kafka |
| APPDEPARTURE_SCHEDULE_INVOCATION            | нет        |    * */15 * * * *                                        | Частота вызова задачи выставления дат доставки             |
